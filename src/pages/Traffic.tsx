  ...
  return (
    <div className="space-y-6">
      ...
      <GlassCard>
        ...
        <CyberChart option={bandwidthChart} height="280px" />
      </GlassCard>

      <div className="grid grid-cols-2 gap-4">
        <GlassCard>
          <h3 className="font-display text-sm font-semibold tracking-wider text-foreground mb-2">协议分布</h3>
          <CyberChart option={protocolPie} height="260px" />
        </GlassCard>
        <GlassCard>
          <h3 className="font-display text-sm font-semibold tracking-wider text-foreground mb-2">Top IP流量排名</h3>
          <CyberChart option={topIPs} height="260px" />
        </GlassCard>
      </div>
